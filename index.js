...
console.log(`All Commands Are Loaded Bot Is Online`);
files.forEach(f => {
...
link.forEach(l => {
ping(l.link)
console.log(`Visting The ${l.link}`)
})
})
}, 60000)

require('http').createServer((req, res) => res.end('Website Is all Set')).listen(3000)
